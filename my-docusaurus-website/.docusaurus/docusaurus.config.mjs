...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/workspaces/velvetcircle/my-docusaurus-website/sidebars.js",
        ...
        "theme": {
          "customCss": "/workspaces/velvetcircle/my-docusaurus-website/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    "navbar": {
      ...
      "items": [
        ...
        {
          "to": "https://github.com/your-github-username/my-docusaurus-website",
          "label": "GitHub",
          "position": "right"
        }
      ],
